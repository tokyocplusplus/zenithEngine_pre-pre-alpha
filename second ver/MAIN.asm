...
SECTION .text
    global _start
    ; i am planning to make a lot of the C code handled by assembly instead, currently I just like the programs into one program and then run it..
    ; im hoping it actually works out but meh maybe, also this is x64 linux NASMxGCC syntax
_start:
